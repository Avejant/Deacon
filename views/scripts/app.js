...
config(['$routeProvider', function($routeProvider) {
    ...
    when('/projects', {
        templateUrl: '/app/layouts/projects.html',
        controller: 'ProjectListCtrl'
    }).
    when('/projects/:id', {
        templateUrl: '/app/layouts/project.html',
        controller: 'ProjectCtrl'
    }).
    when('/issues', {
        templateUrl: '/app/layouts/issues.html',
        controller: 'IssueListCtrl'
    }).
    when('/issues/:id', {
        templateUrl: '/app/layouts/issue.html',
    ...
    when('/profile/:id', {
        templateUrl: '/app/layouts/profile.html',
        controller: 'UserProfileCtrl'
    }).
    when('/users', {
        templateUrl: '/app/layouts/userList.html',
